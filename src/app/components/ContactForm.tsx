...
export default function ContactForm() {
  ...
  return (
    <section className="relative py-10 w-full mt-[70px] sm:mt-[100px] md:mt-[183px] text-center overflow-hidden">
      {/* Flowers */}
      ...
      <div className="z-[50] w-[80%] sm:max-w-[480px] shadow-md rounded-xl px-4 py-10 border-7 border-white/50 mb-[150px] sm:mb-[50px] mx-auto sm:ml-[16%] bg-white relative">
        ...
        >
          We’ll get back to you shortly to answer your questions and guide you
          through anything you’d like to know about our sessions or services{" "}
        </p>
