...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden text-white pt-[152px] pb-[80px]">
      ...
      <button
        onClick={toggleMute}
        className="absolute bottom-0 right-4 z-10 bg-white/50 px-4 py-2 rounded text-black font-semibold"
      >
        {isMuted ? "🔇" : "🔊"}
      </button>

      {/* Регулировка громкости */}
      <div className="absolute bottom-10 right-4 z-10 bg-white/50 px-4 py-2 rounded text-black">
